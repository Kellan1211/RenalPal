...
class BloodPressurePage extends StatelessWidget {
          ...
          children: [
            ...
            Center(
              child: ElevatedButton.icon(
                onPressed: () {
                  // TODO: Navigate to add new BP reading page
                },
  ...
  // Helper method to build a card for each reading
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text('Recorded at $time', style: const TextStyle(fontSize: 14, color: Colors.black54)),
              ],
            ),
          ),
        ],
